...
class BreakPoint(val file: String, val line: Int, val condition: String? = null, val logMessage: String? = null, hitCondition: String? = null, val runToHere: Boolean = false)
